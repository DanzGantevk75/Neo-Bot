...
//━━━━━━━━━━━━━━━[ MENU ]━━━━━━━━━━━━━━━━━//
zeroyt7.setStatus(`Im DanzBot || Runtime : ${kyun(uptime)}`).catch((_)=>_);
...
❱ Runtime : *${kyun(run)}*
`
but = [{ buttonId: `.allmenu`, buttonText: { displayText: 'allmenu 🔥' }, type: 1 },{ buttonId: `.groupbot`, buttonText: { displayText: 'group bot 😈' }, type: 1 },{ buttonId: `.sewabot`, buttonText: { displayText: 'sewabot 🤤' }, type: 1 }]
...
┃✗⃟🕊❱${prefix}delete
┗✮${petik}`
but = [{ buttonId: `.groupbot`, buttonText: { displayText: 'group bot 😈' }, type: 1 }]
...
setTimeout( () => {
reply(`*Terimakasih Telah Mendaftarkan Diri Ke Database DanzBot*`)
}, 3000)
break
...
fakestatus(`Itu Owner Ku Kak ,Mau Tanya Soal Apa Ya?,maaf owner saya tidak menerima sv😊`)
break
case 'report':
...
zeroyt7.sendMessage(`6288270863279@s.whatsapp.net`, options, text, { quoted: fstatus })
...
case 'store':
   ...
   listmenuu = [`owner 🤡`,`script bot 🤤`,`sewabot 🗿`,`murid bot 😇`]
   nombor = 1
   startnum = 0
...
ok = `DanzBot Official By Danzz.`
sendButLoc(from, lolot, ok, img, but)
break
case 'muridbot':
katalog(`Open Murid Bot By Danzz. 
